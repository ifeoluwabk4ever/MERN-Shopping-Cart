...
const ContactForm = () => {
   ...
   return (
      <div>
         <p className="text-muted mb-4 text-right">Your feedback matters alot to us, why not drop a message for us on how best to improve our services and advice you can render to help with our customer services...</p>
         <form onSubmit={handleSubmit} className="shadow transition-shadow p-5">
            <h4 className="text-capitalize text-center">Contact  <span className="title-color">form</span></h4>
            <Underline1 />
